let properties = typeof window === 'undefined' ?
    {
        "commandEndpoint": "",
        "apiEndpoint": "",
        "websocketEndpoint": "",
        "refLink": "",
        "websocketOldEndpoint": "",
        "feedbackEndpoint": ""
    } :
    {
        ...
        "websocketEndpoint": window.location.host === 'localhost:8008' ? "ws://localhost:8008/skyblock" : "wss://sky.coflnet.com/skyblock",
